        ...
        <div class="collapse navbar-collapse flex-grow-0" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item " style="margin-left:40px;">
              <div class="dropdown">
                <a class="dropdown-toggle text-primary" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <img alt="image" src="/newAdmin/dist/assets/img/avatar/avatar-4.png"
                  class="rounded-circle mr-1" style="width:40px;">
                  <div class="d-sm-none d-lg-inline-block text-primary">Hi, {{auth()->user()->name}}</div>
                </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="{{route('transaksi.sewa')}}">Transaksi Sewa</a></li>
                  <li><a class="dropdown-item" href="{{route('transaksi.jual')}}">Transaksi Beli</a></li>
                    <li><a class="dropdown-item">                             
                      <form id="logout-form" action="{{ route('user.logout') }}" method="POST" style="display: flex; align-items: center;">
                        @csrf

    ...
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr class="text-center ">
          ...
          <td class="py-3">{{$item->tgl_pembayaran}}</td>
          <td class="py-3">
          ...
          <td class="py-3">
            <a href="{{route('order.jual.detail',$item->id)}}" class="bg-primary p-2 rounded text-white" style="text-decoration: none !important;">
              Detail
            </a>
          </td>
        </tr>

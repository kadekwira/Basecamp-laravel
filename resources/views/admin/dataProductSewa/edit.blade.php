...
<div class="main-content">
  <section class="section">
    ...
    <div class="row">
      <div class="col-12 ">
        <div class="card">
          <form method="post" action="{{route('product-sewa.update',$data->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="card-header">
              <h4>Edit Data Product Sewa</h4>
            </div>
            <div class="card-body row">
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="harga_hilang" id="harga_hilang" value="@rupiah($data->harga_hilang)">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <label>Harga Telat</label>
                  <input type="text" class="form-control" name="harga_telat"  id="harga_telat" value="@rupiah($data->harga_telat)">
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <label>Harga Rusak</label>
                  <input type="text" class="form-control" name="harga_rusak"  id="harga_rusak" value="@rupiah($data->harga_rusak)">
                </div>
              </div>

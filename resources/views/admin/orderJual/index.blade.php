      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <a href="{{route('order-jual.create')}}" class="btn btn-icon btn-success ml-auto button-header-add"><i class="fas fa-plus"></i></a>
          </div>
          <div class="card-body">
  ...
  $(document).ready(function() {
    $('#tableDataAdmin').DataTable({
      ...
      columns: [
        ...
        { data: 'tgl_pembayaran', name: 'tgl_pembayaran',className: 'text-center' },

            ...
            <div class="card-body row">
              ...
              <div class="col-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="harga_product" name="harga_product" required readonly>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <label>Harga Hilang</label>
                  <input type="text" class="form-control" id="harga_hilang" name="harga_hilang" required readonly>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <label>Harga Telat</label>
                  <input type="text" class="form-control" id="harga_telat" name="harga_telat" required readonly>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
                  <label>Harga Rusak</label>
                  <input type="text" class="form-control" id="harga_rusak" name="harga_rusak" required readonly>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
